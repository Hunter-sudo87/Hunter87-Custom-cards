...
s.listed_series={0x76C}
s.listed_name={21175632}
...
function s.cfilter(c)
	return c:IsSetCard(0x76C) and (c:GetAttack()>0 or c:GetDefense()>0) and c:IsDiscardable()
end
...
function s.thfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x76C) and c:IsAbleToHand()
end
